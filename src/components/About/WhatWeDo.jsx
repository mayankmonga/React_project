    ...
    <section className="what-section">
      <div className="what-content grid grid-cols-1 lg:grid-cols-2 w-[80%] mx-auto gap-4">
        <div className="What-text">
          ...
          <p>
            We specialize in creating custom-designed products that bring
            personality and warmth to homes, offices, and special occasions.
          </p>
          ...
          <p>
            Each product is carefully crafted using high-quality materials and
            modern printing techniques to deliver exceptional results.
          </p>
        </div>
