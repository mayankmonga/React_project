    ...
    return(
        <section className="cathero-section " >
            <div className="container hero-content mx-auto ">
                ...
                <div className="row">
                    <p className="col-md-4 ">Discover premium canvas artwork, custom printing solutions, and handcrafted copper products designed to elevate modern homes and creative spaces.</p>
                </div>
